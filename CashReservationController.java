 ...
 * @author AUSTINS
 */
public class CashReservationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                    ...
                    httpSession.setAttribute("type", "cashreservation");
                            ...
                            if (check_in_date.compareTo(dbDate) == 0) {
                                for (int i = 0; i <= timeList.size(); i++) {
                                    ...
                                    if (localTime.isBefore(lt)) {
                                        ...
                                        Reservation reservation = new Reservation(id, fname, lname, email, phonenumber, check_in_date, check_in_time, check_out_date, check_out_time, medical_condition, payable_amount, room_category, room_position, roomNo, "Not Confirmed", checkedby, paymentMethod);
